...
export default async function Home() {
  const servedRequests = await redis.get("served-request");

  return (
    <section className="min-h-screen bg-grid-zinc-500">
      <MaxWidthWrapper className="relative pb-24 pt-10 sm:pb-32 lg:pt-24 xl:pt-32 lg:pb-52">
        ...
        <div className="px-6 lg:px-0 lg:pt-4">
          <div className="relative mx-auto text-center flex flex-col items-center">
            <h1 className="relative leading-snug w-fit tracking-tight text-balance mt-16 font-bold text-gray-500 text-5xl md:text-6xl">
              What do you{" "}
